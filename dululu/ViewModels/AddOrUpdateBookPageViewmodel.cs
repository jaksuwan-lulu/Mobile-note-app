...
namespace dululu.ViewModels
{
    ...
    public partial class AddOrUpdateBookPageViewmodel : AddBookBaseViewModel
    {
        ...
        public AddOrUpdateBookPageViewmodel(LBookService bookService)
        {
        ...
        // ส่งค่า SelectedCategory ผ่าน MessagingCenter
        [RelayCommand]
        private async Task SendSelectedCategory()
        {
            MessagingCenter.Send(this, "SelectedCategoryMessage", SelectedCategory);
        }
    }
}
